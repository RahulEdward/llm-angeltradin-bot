...
Core agents (MarketDataAgent, StrategyAgent, RiskManagerAgent) are always enabled.
"""
...
class AgentConfig:
    ...
    - MarketDataAgent: Market data fetching (Angel One)
    - StrategyAgent: Technical analysis + decision making
    ...
    multi_period_agent: bool = True          # MultiPeriodParserAgent
    
    # Symbol Selection (adapted for Indian markets)
    symbol_selector_agent: bool = False      # Disabled by default - user selects symbols via UI
    ...
    def from_dict(cls, config: Dict[str, Any]) -> 'AgentConfig':
        ...
        Use AGENT_<NAME>=true/false to override.
        """
        ...
        return cls(
            ...
            multi_period_agent=resolve_flag('multi_period_agent', True),
    ...
    def get_enabled_agents(self) -> Dict[str, bool]:
        ...
        return {
            ...
            'multi_period_agent': self.multi_period_agent,
